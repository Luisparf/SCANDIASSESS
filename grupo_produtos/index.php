...
<script>    
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Cadastro Grupo de Produtos</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../dashboard">Início</a></li>
          <li class="breadcrumb-item">Cadastros</li>
          <li class="breadcrumb-item active" style="margin: 0 0 10px 10px;" >Grupo de Produtos</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                <a style="width:120px; margin: 0 0 0 10px; display:flex; text-align:center; justify-content:center; line-height: 1;" class="btn btn-success" href="add.php"><i class="fa fa-plus"></i> Grupo de Produtos</a>
              </h5>
              ...
              <table  class="table datatable">
                ...
                <tr id="row-grupo">
                   ...
                   <td><?php echo $grupo['atualizadoEm']; ?></td>
                    <td class="actions text-right rowlink-skip" style="text-align: center;">
                        <a href="edit.php?id=<?php echo $grupo['id']; ?>" class="btn btn-xs btn-warning" data-tooltip="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
                        <a href="#" class="btn btn-xs btn-danger" data-tooltip="tooltip" title="Excluir"  onclick="swalDelete(<?php echo $grupo['id']; ?>)"><i class="fa fa-trash"></i></a>
                    </td> 
                </tr>
            <?php } ?> 
                </tbody>
