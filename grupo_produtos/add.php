...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Novo Grupo de Produtos</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
        ...
        <div class="card-body">
          ...
          <form action="add.php" method="post">
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nome" name="grupo['nome']" required>
              </div>
            </div>
            <div class="row mb-3">
              <label for="cod" class="col-sm-2 col-form-label">Código</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="cod" name="grupo['cod']">
              </div>
            </div>
