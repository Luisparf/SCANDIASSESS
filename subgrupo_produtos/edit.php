    ...
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Horizontal Form -->
          <form action="edit.php?id=<?php echo $subgrupo_prods['id']; ?>" method="post">
            <div class="row mb-3">
              <label for="nome" class="col-sm-2 col-form-label">Nome*</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nome" name="subgrupo_prod['nome']" value="<?php echo $subgrupo_prods['nome'] ?>" required>
              </div>
            </div>
            <div class="row mb-3">
              <label for="codigo" class="col-sm-2 col-form-label">Código</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="codigo" name="subgrupo_prod['codigo']" value="<?php echo $subgrupo_prods['id'] ?>">
              </div>
            </div>
