            ...
            <?php else : ?>
                <?php foreach ($products as $product) : ?>
                    <div class="card card-small" data-product-id="<?php echo $product['id']; ?>">
                        ...
                        <div class="card-body">
                            <h5 class="card-title mb-1"><?php echo $product['sku']; ?></h5>
                            <p class="card-text mb-1"><?php echo $product['name']; ?></p>
                            <p class="card-text mb-1"><?php echo $product['price']; ?>$</p>
                            ...
                            <?php if (isset($product['height']) && isset($product['width']) && isset($product['length'])) : ?>
                                <p class="card-text">Dimension: <?php echo $product['height']; ?>x<?php echo $product['width']; ?>x<?php echo $product['length']; ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
